...
def printpromo(image):
    ...
    draw1.rectangle((width*0.625, height*0.35, width*1,height*0.52), fill='red')
    draw1.text((width*0.63, height*0.36), 'Get 50% Off Registration', fill='blue', font=tahomaFont,fontsize=width*0.03)
